...
const Testimonials = () => {
  ...
  return (
    <section className=" tracking-wider max-w-8xl mx-auto px-4 md:px-6 lg:px-24 py-6 lg:py-10">
      {/* TITLE */}
      ...
      <h1 className="flex items-center justify-center gap-1">
        <Link
          to="https://www.google.com/search?sca_esv=635f647f0ac037ee&sxsrf=ANbL-n6kbkYk6fDE1V9ZqrklrnnHLprVvw:1778487763123&si=AL3DRZEsmMGCryMMFSHJ3StBhOdZ2-6yYkXd_doETEE1OR-qOaGgRVVwq6ZQTgdKc7pSjdeqlJ40n_p60aP6UJEijQm0nam7L5AzL5Nb_JaKDbzDk41OzeHPcl3F23nsMo1K1HF4sSdPUXOysP8iR9O3enZvdDishQ%3D%3D&q=Sadguru+Krupa+Furnishing+Reviews&sa=X&ved=2ahUKEwjHzO6a57CUAxX_nq8BHSMkDuEQ0bkNegQIJRAF&biw=1536&bih=730&dpr=1.25"
          className="underline text-blue-500 cursor-pointer font-bold"
        >
          Click Here
        </Link>{" "}
        to check us on
        <img src={IMAGES.googlePng} alt="Logo" className="h-20 w-auto ml-1 " />
      </h1>
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute left-0 top-1/2 mr-16 z-10 -translate-y-1/2 bg-white shadow-lg border border-gray-200 rounded-full w-12 h-12 flex items-center justify-center hover:bg-gray-100 transition"
        >
          ❮
        </button>
        ...
        <button
          ...
          className="absolute right-0 top-1/2 z-10 -translate-y-1/2 bg-white shadow-lg border border-gray-200 rounded-full w-12 h-12 flex items-center justify-center hover:bg-gray-100 transition"
        >
          ❯
        </button>
        ...
        >
          {testimonials.map((item, index) => (
            <SwiperSlide key={index}>
              ...
              >
                <div className="w-full max-w-md lg:w-[400px] border border-black rounded-t-[200px] rounded-b-md px-6 py-10 text-center h-[370px] md:h-[340px] bg-white lg:h-[400px]">
                  {/* Stars */}
